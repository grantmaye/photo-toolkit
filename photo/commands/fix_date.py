...
from photo.core.metadata import build_fixed_date, filename_with_datetime, update_metadata
from photo.core.reports import RunReport
from photo.core.safety import assert_safe_source


def run(folder: Path, date: str, execute: bool, allow_root_path: bool = False) -> Path:
    assert_safe_source(folder, allow_root_path)
    report = RunReport("fix-date")
